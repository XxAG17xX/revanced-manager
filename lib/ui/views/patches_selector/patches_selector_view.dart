            ...
            body: CustomScrollView(
              slivers: [
                SliverAppBar(
                  pinned: true,
                  floating: true,
                  title: Text(t.patchesSelectorView.viewTitle),
                              ...
                              children: [
                                Row(
                                  children: [
                                    ActionChip(
                                      label: Text(
                                        t.patchesSelectorView.defaultChip,
                                      ),
                                      tooltip:
                                          t.patchesSelectorView.defaultTooltip,
                                      onPressed: () {
                                        if (_managerAPI
                                            .isPatchesChangeEnabled()) {
                                          model.selectDefaultPatches();
                                        } else {
                                          model.showPatchesChangeDialog(
                                            context,
                                          );
                                        }
                                      },
                                    ...
                                    ActionChip(
                                      label: Text(
                                        t.patchesSelectorView.noneChip,
                                      ),
                                      tooltip:
                                          t.patchesSelectorView.noneTooltip,
                                      onPressed: () {
                                        if (_managerAPI
                                            .isPatchesChangeEnabled()) {
                                          model.clearPatches();
